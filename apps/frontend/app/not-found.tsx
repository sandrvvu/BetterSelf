  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-indigo-800 via-violet-400 to-neutral text-white/90 flex flex-col">
      <div className="flex-grow flex flex-col justify-center items-center text-center mx-6 px-5">
        <h1 className="text-[7rem] md:text-[9rem] font-gravitas font-extrabold mb-4 drop-shadow-lg">
          404
        </h1>
        ...
        <Link href="/">
            <button className="border-2 border-white text-md md:text-2xl my-10 px-4 py-2 rounded-xl hover:bg-white/90 hover:text-indigo-800 transition">
